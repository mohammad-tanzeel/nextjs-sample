        ...
        <>
            <div className="divFlex topNav">
                <div className='strip-box'>
                    ...
                    <div className="social-icons flex items-center gap-x-4 lg:mr-10">
                        <div className='social-box'>
                            <a
                                className="rounded-full hover:bg-white p-1 hover:text-primary duration-500" href="/"><svg
                                    stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                                    className="cursor-pointer" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                </svg></a><a className="rounded-full hover:bg-white p-1 hover:text-primary duration-500" href="/"><svg
                                    stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024"
                                    className="cursor-pointer" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                                    <path
